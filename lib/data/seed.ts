...
const categoryPathsBySlug: Record<string, string[]> = {
  ...
  perplexity: ["기획/리서치"],
  gemini: ["기획/리서치", "기획/문서 작성", "개발/코드 작성"],
  notebooklm: ["기획/리서치", "기획/문서 작성"],
  genspark: ["기획/리서치", "기획/문서 작성"],
  gamma: ["기획/PPT/제안서", "기획/문서 작성"],
  tome: ["기획/PPT/제안서", "기획/콘텐츠"],
  "beautiful-ai": ["기획/PPT/제안서", "디자인/브랜드/그래픽"],
  "napkin-ai": ["기획/콘텐츠", "기획/PPT/제안서", "디자인/UX/UI"],
  skywork: ["기획/PPT/제안서", "기획/문서 작성", "기획/리서치"],
  midjourney: ["디자인/이미지"],
  "dall-e": ["디자인/이미지", "기획/콘텐츠"],
  ideogram: ["디자인/이미지", "디자인/브랜드/그래픽"],
  recraft: ["디자인/이미지", "디자인/브랜드/그래픽"],
  "canva-ai": ["디자인/이미지", "디자인/브랜드/그래픽", "기획/콘텐츠"],
  "figma-ai": ["디자인/UX/UI"],
  "adobe-firefly": ["디자인/이미지", "디자인/브랜드/그래픽"],
  runway: ["디자인/영상"],
  kling: ["디자인/영상"],
  pika: ["디자인/영상"],
  "krea-ai": ["디자인/이미지", "디자인/브랜드/그래픽"],
  "freepik-ai": ["디자인/이미지", "디자인/브랜드/그래픽"],
  cursor: ["개발/코드 작성", "개발/디버깅"],
  "github-copilot": ["개발/코드 작성", "개발/디버깅"],
  "openai-codex": ["개발/코드 작성", "개발/자동화"],
  replit: ["개발/웹사이트 제작", "개발/코드 작성"],
  "bolt-new": ["개발/웹사이트 제작", "개발/코드 작성"],
  lovable: ["개발/웹사이트 제작"],
  v0: ["개발/웹사이트 제작", "디자인/UX/UI"],
  windsurf: ["개발/코드 작성", "개발/디버깅"],
  devin: ["개발/자동화", "개발/코드 작성"],
  codeium: ["개발/코드 작성", "개발/디버깅"],
  "notion-ai": ["기타/생산성", "기획/문서 작성"],
  "slack-ai": ["기타/협업", "기타/생산성"],
  "zapier-ai": ["개발/자동화", "기타/생산성"],
  make: ["개발/자동화", "기타/생산성"],
  elevenlabs: ["기획/콘텐츠", "디자인/영상"],
  suno: ["기타/생산성", "기획/콘텐츠"],
